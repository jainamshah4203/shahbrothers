/**
 * Soft elevation — charcoal ink at low opacity (never cool gray).
 * Paper / premium: `0 10px 30px -5px rgba(26,26,26,0.06)`
 */
...
export const shadowTokens = {
  ...
  /** Soft paper lift — primary product / card elevation */
  paper: '0 10px 30px -5px rgba(26, 26, 26, 0.06)',
  /** Alias for paper — editorial layouts */
  editorial: '0 10px 30px -5px rgba(26, 26, 26, 0.06)',
  /** Deeper lift for modals / featured heroes */
