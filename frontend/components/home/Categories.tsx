...
function CategoryCard({
  ...
  return (
    <Link
      href={category.href}
      className={`group relative block h-full min-h-0 overflow-hidden focus-ring ${className ?? ""}`}
    >
      <div className="relative h-full w-full overflow-hidden bg-cream p-3 md:p-4">
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-charcoal-ink/60 via-charcoal-ink/15 to-transparent" />
...
export const Categories: React.FC = () => {
  const revealRef = useRevealAnimation<HTMLElement>({ preset: "fadeUp" });
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-12 md:gap-5 md:items-stretch">
          <div className="md:col-span-5 lg:col-span-5">
            <CategoryCard category={tall} className="h-full" />
          </div>
